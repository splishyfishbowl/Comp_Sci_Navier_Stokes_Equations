...
So far we have ignored any forcing in the velocity equation of the Navier-Stokes equation. In
the following section we want to introduce thermal forcing to reproduce the Rayleigh-Bernard
convection cells. Just to name one example, they occur in climatology on different scales and
convective phenomena are important in various proccesses all over the global atmospheric
system. In this section, we want to find adequate initial conditions and parameters to
reproduce such a convective behavior using our solutions.
